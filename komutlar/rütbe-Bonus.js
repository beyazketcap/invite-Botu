...
//pythonic
    ...
    if(!victim) return message.reply("Lütfen Birini Etiketleyiniz");//pythonic//pythonic
    victim = message.guild.member(victim);//pythonic
    if(!victim) return message.reply("Etiketlediğiniz Kişi Sunucuda Bulunmamaktadır.");//pythonic
    ...
    message.channel.send(`${victim} Adlı Kişiye ${num} Tane Bonus Eklendi.`);//pythonic
...
exports.help = {
  name: 'bonus-ekle',
  description: 'Bonus invite eklersiniz',
  usage: 'bonus'
};
